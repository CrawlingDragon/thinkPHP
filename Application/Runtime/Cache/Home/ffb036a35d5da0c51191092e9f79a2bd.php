				...
				<div class="goodsDetail-top-midden"><!-- 商品详情选择规格数量 -->
					...
					<div class="dataBox">
						<div class="price-wrap">
							...
							<strong><i class="">¥</i><em style="vertical-align: bottom;">8.00-109.00</em></strong>
						</div>
						...
						<div class="specification-wrap clear">
							<span class="labels" style="display: block;float: left;">选择规格:</span>
