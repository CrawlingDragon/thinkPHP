	...
	<section class="containar"><!-- 主体内容开始 -->
		...
		<div class="indexCont clear"><!-- 处理订单内容部分开始 -->
			...
			<div class="myAssets"><!--  我的资产 -->
				<div class="orders-title" style="margin-bottom: 15px;"><span class="colors"></span>我的资产<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/closeEye.png" alt="" class="img1" id="img1"><!-- <img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/closeEye.png" alt="" class="img2" id="img2"> --></div>
