...
<body>
	...
	<section class="container"> <!-- 主体内容开始 -->
		...
		<section class="main-warp">
			...
			<div class="person-side fr"> <!-- 农技专家 -->
				<h3 class="main_title f14song">农技专家</h3>
				<div class="bd">
					<ul><!-- 专家列表 -->
					<li class="person-list"> 
						...
						<a href="" class="f14song">咨询</a>
					</li>
					<li class="person-list"> 
						<div class="icon"><img src="" ></div>
						<dl class="text">
							<dt class="f14song">李晓</dt>
							<dd>浙江大学昆虫研究所教授，原浙江大学副校长</dd>
						</dl>
						<a href="" class="f14song">咨询</a>
					</li>
					<li class="person-list"> 
						<div class="icon"><img src="" ></div>
						<dl class="text">
							<dt class="f14song">王华弟</dt>
							<dd>浙江省农业厅农药检定管理所推广研究员</dd>
						</dl>
						<a href="" class="f14song">咨询</a>
					</li>
					<li class="person-list"> 
						<div class="icon"><img src="" ></div>
						<dl class="text">
							<dt class="f14song">贾惠娟</dt>
							<dd>浙江大学果树科学研究所教 授</dd>
						</dl>
						<a href="" class="f14song">咨询</a>
					</li>
				</ul>
