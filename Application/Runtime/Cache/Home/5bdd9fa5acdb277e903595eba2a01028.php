...
<body>
	...
	<section class="container"> <!-- 主体内容开始 -->
		...
		<section class="main-warp">
			...
			<div class="person-side fr"> 
				<div class="store-intro-side">
					<div style="overflow: hidden;">
						<img src="/Public/mall/wuhelong/images/stor-logo.gif" class="fl">
						<strong class="fl">海南正业中农高科股份有限公司</strong>
					</div>
					<div class="txt">
			...
			<script type="text/javascript">
				jQuery(".person-side").slide({mainCell:".bd ul",autoPlay:true,effect:"topMarquee",vis:4,interTime:50});
			</script>
		...
		<div class="side fl">
			...
			<!-- <div class="garden-sort">
				...
				<ul>
					...
					<li><a href="">&middot;科佳对荔枝霜疫霉病的防治及荔枝霜疫霉荔枝霜疫霉荔枝霜疫霉...</a></li>
			...
			<div class="garden-sort">
				<h3 class="main_title f14song">热销商品
					<a href="植保园地.html" class="more">查看更多></a>
				</h3>
				<dl class="goods-item"> 
		...
		<div class="main fr">
			<div class="hot-goods"> <!-- 推荐商品 -->
				<h3 class="main_title f14song">推荐商品
				...
				<ul class="goodsList-ul clear">
					<li>
                        <div class="goodsList-wrap">
	                        <a href="/Index/Category/goods/id/350.html">
	                            <!-- 大图begin -->
	                            <div class="spec-preview"> 
	                                <span class="jqzoom"><img jqimg="" src="http://img09.114nz.com/1201503057828/Product/55482a519cffd_thumb.jpg"></span>
	                            </div>
	                        </a>
                            <!-- 大图end -->
                            <!-- 缩略图begin -->
                            <div class="spec-scroll">
								<div class="items">
									<ul>
									    <li class="active">
									        <img bimg="" src="http://img09.114nz.com/1201503057828/Product/55482a519cffd_thumb.jpg" class="smallImg">
									    </li>
									    <li class="">
									        <img bimg="" src="http://img09.114nz.com/12015042216364/Product/55d3ed991a7bc_thumb.jpg" class="smallImg">
									    </li>
									</ul>
								</div>
                            </div>
                            <!-- 缩略图end -->
                            <h5>燕化 非常火 烯啶 吡蚜酮 杀虫剂</h5>
                            <div class="btns">
	                            <a href="/Index/Category/goods/id/350.html" class="car">加入购物车</a>
	                            <!-- <span class="collect" onclick="addCollect('350')">收藏</span> -->
	                            <span class="collected" onclick="addCollect('350')">已收藏</span>
                            </div> 
                        </div>
                    </li>
                    <li>
                        <div class="goodsList-wrap">
                            ...
                            <!-- 缩略图end -->
                            <h5>燕化 非常火 烯啶 吡蚜酮 杀虫剂</h5>
                            <div class="btns"><a href="/Index/Category/goods/id/350.html" class="car">加入购物车</a>
                            <span class="collect" onclick="addCollect('350')">收藏</span></div> 
                        </div>
                    </li>
                    <li>
                        <div class="goodsList-wrap">
			...
			<div class="new-goods"> <!-- 新品推荐 -->
				<h3 class="main_title f14song">新品推荐
					<a href="###" class="more">查看更多></a>
				</h3>
				<!-- 新品推荐列表 -->
				<ul class="goodsList-ul clear">
