...
<head>
	...
	<!-- <link rel="stylesheet" href="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/css/bscommon.css" type="text/css"> -->
	...
	<section class="containar"><!-- 主体内容开始 -->
		<div class="containarWrap clear">
			...
			<div class="rightBar"><!-- 右边内容 -->
				...
				<div class="safeLv">
					安全级别:
					<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeLv1.png" alt="" style="display: none;">
					<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeLv2.png" alt="">
					<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeLv3.png" alt="" style="display: none;">
					<span>中级</span>
					<i>建议您启动全部安全设置，以保障账户及资金安全</i>
				</div>
				<ul class="safeBox">
					<li>
						<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeRight.png" alt="" class="right"><!-- 正确时的图片 -->
						<!-- <img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeWarn.png" alt="" class="warn">警告时的图片 -->
						<!--<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeError.png" alt="" class="error">错误时的图片 --> 
						<h5>登录密码</h5>
						<span>密码强度为:<i>中</i></span>
						<a href="/home/CommonPersonal/logoPwd.html" class="change">修改</a>
					</li>
					<li>
						<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeWarn.png" alt="" class="warn">
						<h5>邮箱验证</h5>
						<span>已添加的邮箱：28***4@163.com</span>
						<a href="/home/CommonPersonal/emailSet.html" class="now">马上验证</a>
						<a href="/home/CommonPersonal/emailSet.html" class="change">修改</a>
					</li>
					<li>
						<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeWarn.png" alt="" class="warn">
						<h5>绑定手机</h5>
						<span>已添加的手机：158****47</span>
						<a href="/home/CommonPersonal/phoneSet.html" class="now">立即绑定</a>
						<a href="/home/CommonPersonal/phoneSet.html" class="change">修改</a>
					</li>
					<li>
						<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeError.png" alt="" class="error">
						<h5>支付密码</h5>
						<span>密码强度为:<i>强</i></span>
						<a href="/home/CommonPersonal/payPwd.html" class="change">修改</a>
					</li>
					<li>
						<img src="<?php echo (C("STYLE_URL")); ?>/PersonalCenter/Common/Image/safeError.png" alt="" class="error">
						<h5>安全问题</h5>
						<span>设置完成后，找回密码时可通过回答问题迅速找回</span>
						<a href="/home/CommonPersonal/safeAnswer.html" class="btn">立即设置</a>
					</li>
				</ul>
			</div><!-- 右边内容end -->
		</div>
