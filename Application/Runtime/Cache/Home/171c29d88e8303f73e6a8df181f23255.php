...
<head>
	...
	<link rel="stylesheet" href="/Public/mall/wuhelong/css/seller.css" type="text/css">
...
<body>
	<header><!-- 头部开始 -->
		<article class="headerTop clear">
			<section class="header-left"> <!-- 头部左边 未读消息 -->
				<a href="消息.html" class="message-title">
					<div><img src="images/messageImg3.png" alt="">未读消息<span class="fb messageNum">10</span></div></a>
			...
			<section class="header-right"> <!-- 头部右边导航 -->
				<ul>
					...
					<li class="list4">
						<a href="买家用户中心.html" class="list-title">卖家中心</a>
						<ul class="list1-cont" style="display: none;">
		...
		<article class="sellerNav clear">
			<dl class="clear">
				<dt><a href="">首页</a></dt>
				<dd><a href="">宁波金泰</a></dd>
				<dd><a href="">苍南永丰</a></dd>
				<dd><a href="">萧山农资</a></dd>
				<dd><a href="">浙北惠多利</a></dd>
				<dd><a href="">嘉兴金泰</a></dd>
			</dl>
			<div class="areaShops"> <!-- 区域商铺开始 -->
					<div class="shopTitle"><div >区域商铺</div></div>
					<div class="shopContent"> <!-- 区域商铺的显示内容 -->
						<form action="">
							<select id="aa">
										...
										<dd><a href=""><p>浙北惠多利农资销售有限公司</p>
											...
											<dd><a href=""><p>嘉兴市金泰农资有限公司</p>
												<span>
													<img src="images/start2.png" alt="">		
													<img src="images/start2.png" alt="">
													<img src="images/start2.png" alt=""></span></a></dd>
		...
		<div class="sellerHr"></div>
	</header><!-- 头部结束 -->

	<section class="container"><!-- 主体内容开始 -->
		<div class="containerBox clear">
			<div class="leftPart"> <!-- 左边导航公共部分开始 -->
				<h4>卖家中心</h4>
				<dl>
					<dt>交易管理</dt>
					<dd><a href="" class="green">已卖出的商品</a></dd>
					<dd><a href="">评价管理</a></dd>
				</dl>
				<dl>
					<dt>商品管理</dt>
			...
			<div class="rightPart"> <!-- 右边主体内容 -->
				...
				<div class="rightCont sellerIndex clear" style="height: 180px;min-height: 180px;margin-bottom: 10px;border:none;"> <!-- 右边的正文内容 -->
					<div class="sellerIndex-left clear">
						<div class="headPortrait">
							<div class="imgs"><img src="images/sellerIndex.jpg" alt=""></div>
							<a href="">编辑资料</a>
						</div>
						<div class="sellerIndex-leftCont" style="width: 595px">
							<h4>亲爱的掌柜：<span>139***449</span></h4>
							<div class="leftCont-top"><a href="">账户安全设置</a><a href="">子账号设置</a><a href="">银行卡(3)</a></div>
							<div class="leftCont-midden">
								<div>
									<h5>账户余额：</h5>
									<span class="orange">¥0.00</span>
									<a href="">充值</a>|
									<a href="">提现</a>|
									<i class="showMoney">隐藏金额</i>
								</div>
							...
							<div class="leftCont-bottom">
								<a href="">新申请账户认证<span class="orange">( 11)</span></a>
								<a href="">授信申请<span class="orange">(21)</span></a>
								<a href="">额度调整申请<span class="orange">(9)</span></a>
								<a href="">代理申请<span class="orange">(9)</span></a>
							</div>
						</div>
					</div>
					<div class="sellerIndex-right clear">
						<div class="companyImg">
							<div class="imgs"><img src="images/company.jpg" alt=""></div>
							<a href="">编辑资料</a>
						</div>
						<div class="sellerIndex-rightCont">
							<dl>
								<dd><h5>宁波金泰惠多利农资连锁有限公司</h5></dd>
								<dd style="margin-bottom: 15px;">会员号：12345678987654321</dd>
								<dd>卖家类型：<span>厂家</span></dd>
								<dd>描述相符：<span class="f14 orange fb">4.9</span>分
								<i>
									<img src="images/start2.png" alt="">
									<img src="images/start2.png" alt="">
									<img src="images/start2.png" alt="">
								...
								<dd>服务态度：<span class="f14 orange fb">4.9</span>分
									<i>
										<img src="images/start2.png" alt="">
										<img src="images/start2.png" alt="">
										<img src="images/start2.png" alt="">
								...
								<dd>发货速度：<span class="f14 orange fb">4.9</span>分
									<i>
										<img src="images/start2.png" alt="">
										<img src="images/start2.png" alt="">
										<img src="images/start2.png" alt="">
							...
							<table class="listBox"><!-- 一个订单开始 -->
								<tr style="width: 900px;height: 30px;"><!-- 订单标题 -->
									<th colspan="5">
										...
										<div class="delet"><img src="images/delete.png" alt=""></div><!-- 删除图片 -->
									</th>
								...
								<tr style="border-bottom: 1px solid #e4f7d4;">
									<td class="listCont listCont1" >
										<div class="goodsInfo"><!-- 商品信息Start -->
											<div class="goods1"> <!-- 单个商品的信息start -->
												<div><a href=""><img src="images/goods5.png" alt=""></a></div>
												<div class="goodsName">
									...
									<td class="listCont" style="width: 16px;">
										<div class="printImg">
											<a href="打印机.html"><img src="images/print.png" alt=""></a>
										</div>
									</td>
								</tr>
							</table><!-- 一个订单END -->
				...
				<div class="rightCont" style="min-height: 355px;margin-top: 10px;"> <!-- 右边的正文内容 -->
					<div class="table-left">表格1</div>
					<div class="table-right">表格2</div>
				</div>
				<!-- 右边的正文内容结束 -->
			</div>
		</div>
...
$('.showMoney').click(function(){
	var thisTxt = $(this).text();
 	var childrenTxt = $(this).parent().children().eq(1)
 	if(thisTxt == "显示金额"){
		childrenTxt.text("¥0.00");
		$(this).text("隐藏金额");
		childrenTxt.removeClass('active');
		console.log(childrenTxt.text());
 	}else{
 		$(this).text("显示金额");
 		childrenTxt.text("");
 		childrenTxt.addClass('active');
 		console.log(childrenTxt.text());
 	}
})
//显示金额end
$(document).ready(function(){  
	$(".sendGoods").click(function(){  //立即发货按钮弹出
	layer.open({
		    type: 1,
		    title:false,
	...
	$(".modify").click(function(){  //修改价格按钮弹出
	layer.open({
		    type: 1,
		    title:false,
		    ...
		    area: ['489px', '350px'],
		    shadeClose: false, //开启遮罩关闭
		    content: '<div class="modifyCont"><p style="margin: 10px 0 30px 20px;">修改订单号为 10012015060153824 的价格</p><p style="margin:15px 0 0 94px;" class="pupopItem">订单总金额：30000.00元</p><p style="margin:15px 0 0 80px;" class="pupopItem"><lebal>修改产品价格：</lebal><input type="text" name="" value="">&nbsp元</p><p style="margin:15px 0 0 80px;" class="pupopItem"><lebal>修改运费价格：</lebal><input type="text" name="" id="" />&nbsp元</p><p style="margin:15px 0 0 51px;" class="pupopItem">修改后订单总金额： 50000.00元</p><p style="margin: 40px 0 40px 176px;"><input type="button" value="确认" class="modifyBtn1"><input type="button" value="取消" class="modifyBtn2"></p></div>',
		    success:function(){
	...
	layer.open({
		    ...
		    area: ['490px', '152px'],
		    shadeClose: false, //开启遮罩关闭
		    content: '<div class="deletCont"><p style="margin: 10px 0 30px 20px;">交易完成，可删除无效订单，将不会产生任何影响</p><p style="margin:40px 0 40px 83px;"><label>确认删除此订单：</label><input type="button" value="确认" class="deletBtn1"><input type="button" value="取消" class="deletBtn2"></p></div>',
	...
	$(".closeOrder").click(function(){  //关闭订单按钮弹出
		_this = $(this).parent();
		_prev = _this.prev();
	layer.open({
		    type: 1,
		    ...
		    area: ['490px', '152px'],
		    shadeClose: false, //开启遮罩关闭
		    content: '<div class="deletCont"><p style="margin: 10px 0 30px 20px;">买家还未付款，确认关闭订单，此订单将失效</p><p style="margin:40px 0 40px 83px;"><label>确认关闭此订单：</label><input type="button" value="确认" class="closeBtn1"><input type="button" value="取消" class="closeBtn2"></p></div>',
		    success:function(layero, index){
