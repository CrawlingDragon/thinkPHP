...
<body>
	...
	<section class="main-wrap">
		...
		<div class="main-form">
			...
			<!-- 邮件发送失败 -->
			<div id="email-no">
				<div class="email-pic fl" style="background:url(/Public/mall/images/appealError.png) no-repeat right 0;"></div>
				<div class="email-text fl">
					<h4>验证邮件已发送失败！</h4>
					<p style="color:#ff6600;">（请检查邮箱地址是否输入正确）</p>
					<a href="" class="form-btn2" style="background:#599524;">返回</a>
				</div>
			</div>
