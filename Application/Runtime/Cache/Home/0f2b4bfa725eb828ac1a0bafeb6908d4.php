			...
			<div class="rightBar"><!-- 右边内容开始 -->
				<div class="rightPart"> <!-- 右边主体内容 -->
					...
					<div class="rightCont"> <!-- 右边的正文内容 -->
						<h3>已卖出的商品</h3>
						<form action="">
							<div class="searchTitle" style="width: auto;padding-top: 15px;">
								<label>交易状态:</label>
							...
							<div class="searchBox">
							<input type="text" name="" id=""  placeholder="输入商品名称或者订单号进行搜索">
							...
							<div class="tableBox" style="margin-left: -15px;">
								<dl class="tr1 clear">
								...
								<table class="listBox"><!-- 一个订单开始 -->
									<tr style="width: 900px;height: 30px;"><!-- 订单标题 -->
										<th colspan="5">
											...
											<div class="delet" onclick="deletOrder()"><img src="/Public/Mall/PersonalCenter/FarmMallPersonal/JIC/Image/delete.png" alt=""></div><!-- 删除图片 -->
											<div class="printImg">
												<a href="/home/FarmMallPersonal/printer.html"><img src="/Public/Mall/PersonalCenter/FarmMallPersonal/JIC/Image/print.png" alt=""></a>
											</div>
										</th>
									...
									<tr class="tr-border">
										...
										<td class="listCont" style="width: 132px;">
											<div class="operate">
												<input type="button" value="立即发货" class="sendGoods" onclick="sendGoods()">
												<a href="/home/FarmMallPersonal/buyerGoEvaluate.html" class="op-evaluation">评价</a>
												<input type="button" value="修改价格" class="modify" onclick="changePrice()">
