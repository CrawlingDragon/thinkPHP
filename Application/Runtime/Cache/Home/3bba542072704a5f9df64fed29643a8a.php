...
<body>
	...
	<section class="main-wrap">
		...
		<div class="main-form">
			...
			<!-- 邮件发送成功 -->
			<div id="email-ok" >
				<div class="email-pic fl" style="background:url(/Public/mall/images/appealOk.png) no-repeat right 0;"></div>
				<div class="email-text fl">
					<h4>验证邮件已发送成功！</h4>
					<p style="color:#ff6600;">（请立即完成验证，邮箱验证不通过则验证邮箱失败）</p>
					<p style="color:#666;">验证邮件2小时内有效，请尽快登录您的邮箱点击验证链接完成验证</p>
					<a href="" class="form-btn2">查看验证邮件</a>
				</div>
			</div>
