			...
			<div class="rightBar emailWrap"><!-- 右边内容 -->
				...
				<form action="" class="emForm">
					<div class="list">
						...
						<input type="text" name="" id="" onkeyup="Emails(this)" onblur="Emails(this)">
					...
					<div class="list">
						...
						<input type="text" name="" id="" class="emCode" onkeyup="emCodes(this)" onblur="emCodes(this)">
						<input type="button" value="发送邮箱验证码" class="emBtn" onclick="settime(this)">
						<a href="/home/CommonPersonal/help.html" class="green f12">没有收到邮件?</a>
						<p class="errorMsg"></p>
					</div>
					<div class="list">
						<label for="">验证码:</label>
