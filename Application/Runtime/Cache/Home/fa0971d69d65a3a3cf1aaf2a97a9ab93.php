										...
										<div class="passed">
											<table>
												...
												<tr>
													...
													<td>12344445656112</td>
													<td>厂家</td>
													<td class="orange fb restore active"><i class="f14">已引用</i></td>
												</tr>
												<tr>
												<td>ZNZX200</td>
													<td>我是肥料一个，我是一个粉料号码</td>
													...
													<td>12344445656112</td>
													<td>厂家</td>
													<td class="orange fb restore" onclick="confirmYes('引用商品后，商品将自动进入“仓库中的商品”','您确认要引用该订单么：')"><i class="f14">引用商品</i></td>
												</tr>
											</table>
										</div>
									<!-- 审核通过结束 -->
									...
									<div class="terminationList">
										<table>
											...
											<tr>
												...
												<td>12344445656112</td>
												<td>厂家</td>
												<td class="orange fb restore"><i class="f14">重新申请</i></td>
											</tr>
											<tr>
												<td>ZNZX200</td>
												<td>我是肥料一个，我是一个粉料号码</td>
