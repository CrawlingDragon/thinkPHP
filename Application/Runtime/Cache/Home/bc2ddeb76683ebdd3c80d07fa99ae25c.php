...
<head>
	...
	<link rel="stylesheet" href="/Public/mall/css/seller.css" type="text/css">
...
<body>
	...
	<section class="container"><!-- 主体内容开始 -->
		<div class="containerBox clear">
			<article class="wealthOrderDetails">
				<!-- 当前位置开始 -->
				<div class="current">
					<span>当前位置:</span>
					<a href="">首页</a>
				...
				<!-- 当前位置结束 -->
				<div class="wealthOrderDetails-head">
					<h2>当前状态：<span class="orange">商家已经发货，等待买家确认</span></h2>
					<div class="wealthOrderDetails-headBar"><!-- 进度条部分开始 -->
						<p>
							<span class="fb" style="color: #589325">拍下商品</span>
							<span>等待买家付款</span>
							<span style="margin-right: 153px;">等待卖家发货</span>
							<span>等待买家收货</span>
							<span style="margin:0">完成</span>
						</p>
						<div class="wealthOrderDetails-headBarbg"></div>
						<div class="wealthOrderDetails-headBartimes">
					...
					<!-- 进度条部分结束 -->
					<p class="wealthOrderDetails-times">当前订单状态：<span>买家已拍下商品，等待买家付款</span></p>
					<p class="wealthOrderDetails-confirm">您可以<a href="" class="green">修改价格</a><a href="" style="border:none;margin-left:0;">关闭订单</a></p>
				</div>
				<div class="wealthOrderDetails-mid clear">
					<div>
						<h4>订单信息</h4>
						<p>买家姓名：王思聪</p>
						<p>会员号：1234567890987</p>
						<p>收货地址：王思聪，15306528524，浙江省杭州市滨江区泰安路199号，311500</p>
						<p>买家留言：--</p>
					</div>
					<div>
						<h4>买家信息</h4>
						<p>商家：苍南县永丰村农业生产资料有限公司</p>
						<p>企业ID：1234567890987</p>
						<p>联系电话：15306528524</p>
						<p>发货地址：王思聪，15306528524，浙江省温州苍南县，311500</p>
					</div>
				</div>
				<div class="wealthOrderDetails-title green">订单号：1234567890987654</div>
				<table>
					<tr style="border:1px solid #e5e5e5;border-bottom:none;">
						<th style="width: 361px">商品</th>
						<th style="width: 113px">规格</th>
						<th style="width: 89px">单价/数量</th>
						<th style="width: 100px">总价(元)</th>
						<th style="width: 90px">运费(元)</th>
						<th style="width: 117px">状态</th>
						<th style="width: 260px">商品实收总金额(元)</th>
					</tr>
					<tr>
						<td >
							<div class="imgs"><a href=""><img src="/Public/mall/images/goods5.png" alt=""></a></div>
							<div class="tableTxt"><a href="">道儿纯硫酸复合葡萄酸专用多功能棚摸过果蔬钙肥道尔纯硫酸钾复合</a></div>
						</td>
						<td>
							<p>
								<span>40kg/包</span>
						...
						<td>
							<p>
								<span  class="tableP">2000.00</span>
								<span>1000.00</span>
							</p>
							<p>
								<span  class="tableP">2000.00</span>
						...
						<td class="orange fb tableActive">
							未付款
						</td>
						<td class="tableAllnum">3000.00</td>
					</tr>
					<tr>
						<td >
							<div class="imgs"><a href=""><img src="/Public/mall/images/goods5.png" alt=""></a></div>
				...
				<div class="tableBottom">
					<p><em class="orange">3&nbsp</em><i>件商品，总商品金额：</i><span><em class="f16 rmb">¥ </em>3000.00</span></p>
					<p><i>运费：</i><span><em class="f16 rmb">¥ </em>30.00</span></p>
				</div>
				<div class="tableMoney f16 c3 fb">订单应收总额：<span>¥2970.00</span></div>
			</article>
		</div>
	</section><!-- 主体内容结束 -->
